  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ color: "var(--app-label-color, rgba(0,0,0,0.75))" }}
      >
        {label}
      </span>
    </motion.button>
  ...
  return (
    <div className="min-h-full flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between px-6 pt-3 pb-1">
        <span className="text-[13px] font-semibold" style={{ color: isDark ? "#fff" : "#000" }}>
          {timeStr}
        </span>
          ...
          <div className="flex gap-[2px] items-end">
            {[3, 5, 7, 9].map((h, i) => (
              <div
                ...
                style={{ height: h, background: isDark ? "#fff" : "#000", opacity: 0.5 }}
              />
            ))}
          </div>
          <span className="text-[11px] font-medium ml-0.5" style={{ color: isDark ? "#fff" : "#000" }}>
            5G
          </span>
          <div
